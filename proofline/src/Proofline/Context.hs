...
bind (Context env l types bds pos) x ~a =
  Context (env :> var l) (l + 1) (types :> (x, a)) (bds :> Bound) pos

-- | Extend Context with a definition.
define :: Context -> Name -> Value -> VTy -> Context
define (Context env l types bds pos) x ~t ~a  =
  Context (env :> t) (l + 1) (types :> (x, a)) (bds :> Defined) pos
